...
CHECKPOINT_DIR = (
    "316L_CPFEM_tensile_2percent_stepwise_checkpoints"
)
...
TOTAL_STRAIN = 0.0200          # 2.00% total tensile strain
...
while current_strain < TOTAL_STRAIN - 1.0e-14:
    ...
    for global_iter in range(
        ...
        # ----------------------------------------------------
        # MEMORY-SAFE BLOCKED ELEMENT TANGENT ASSEMBLY
        # ----------------------------------------------------
        ...
        # ----------------------------------------------------
        # Release previous LU factorization before creating
        # the new one
        # ----------------------------------------------------
        ...
        # ----------------------------------------------------
        # Release sparse tangent matrix after LU factorization
        # K_solver_alg now owns the factorization.
        # K_ff_alg is no longer required.
        # ----------------------------------------------------

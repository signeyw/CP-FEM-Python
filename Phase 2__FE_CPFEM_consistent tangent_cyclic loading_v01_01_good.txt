...
while cyclic_segment < len(cyclic_targets):
    ...
    plastic_strain_committed = trial_plastic.copy()
    resistance_committed = trial_resistance.copy()
    accumulated_slip_committed = trial_accumulated.copy()
    cp_x_committed = trial_slip.copy()
    ...
    # We will calculate J2 equivalent plastic strain separately

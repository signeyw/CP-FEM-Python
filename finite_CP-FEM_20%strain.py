...
CHECKPOINT_DIR = (
    "316L_CPFEM_tensile_20percent_stepwise_checkpoints"
)
...
while current_strain < TOTAL_STRAIN - 1.0e-14:
    ...
    for global_iter in range(
        ...
        for e in range(n_elements):
            ...
            #     print("------------------------------------------------")
            #     print(
            #         f"CPFEM LOCAL SOLVER FAILED AT ELEMENT {e}"
            #     )
            #     print(
            #         f"Global load step : {step}"
            #     )
            ...
            # trial_cp_residual[e] = cp_res
        
            # trial_cp_iterations[e] = cp_niter
        ...
        # ============================================================
        # FINITE-STRAIN GLOBAL TANGENT
        # ============================================================
        #
        # Ke = G.T @ (dP/dF) @ G * V0
        #
        # This is currently a frozen-Fp finite-strain
        # quasi-Newton tangent.
        # ============================================================
        ...
        for e in range(n_elements):
            ...
            #
            # IMPORTANT:
            # For the tangent, Fp is held fixed.
            # --------------------------------------------------------
